...
* when multiple *DAQModules* are present within a *DAQProcess*, they communicate with each other via *Queues* (the diagrams that are included [later on this page](Step-by-step-instructions-for-creating-your-own-DAQModule-package.md) might help explain this)
