...
This page is intended to provide a step-by-step guide to setting up a work area in which you create software *modules* that run within the DUNE DAQ software application framework (*appfwk*). These modules are often called _DAQModules_ since that is the C++ base class that they inherit from. If you are impatient to get started, you can jump to the [Step-by-step Instructions](Step-by-step-instructions-for-creating-your-own-DAQModule-package-under-v1.1.0.md) now.  
...
* [Compiling and running the App Fwk](Compiling-and-running-under-v1.1.0.md)

* [Creating a new package](Creating-a-new-package-under-v1.1.0.md)
...
Instructions on setting up a work area in which you can create your new package can be found [here](Compiling-and-running-under-v1.1.0.md). After you've gone through those instructions, for our purposes the first build command we'll want to run will one which installs appfwk in a local `./install` subdirectory. 
    * `./build_daq_software.sh --install`
You can then link your own code against your local installation of appfwk. 

* If you would like to try running the example application(s) from the core *appfwk* repository, you can do that now.  There are instructions [later on this page](Step-by-step-instructions-for-creating-your-own-DAQModule-package-under-v1.1.0.md) for doing that. 
