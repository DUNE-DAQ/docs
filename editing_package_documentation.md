...
or to other webpages, where necessary. Markdown
...
* If you create a list of bulleted items, use an asterisk to do so; while other techniques may display fine on GitHub they may not display fine on this site. E.g., `* This is an example of a good bullet point technique` vs. ` - This may not show up well`.

* If you have a graphic file to display in your documentation, put it in the `docs/` directory as well, and refer to it without an html link or even a path. E.g., `![drunc_overview](drunc_overview.png)` rather than `![drunc_overview](https://github.com/DUNE-DAQ/drunc/blob/develop/docs/drunc_overview.png)`
