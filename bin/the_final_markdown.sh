...
package_list="trigger trigemu timinglibs timing serialization restcmd readoutmodules readoutlibs rcif opmonlib nwqueueadapters networkmanager ndreadoutlibs nanorc kafkaopmon logging listrev lbrulibs hdf5libs ipm integrationtest influxopmon flxlibs fdreadoutlibs erskafka ers dfmodules dfmessages detdataformats detchannelmaps daqdataformats daqconf cmdlib appfwk styleguide daq-release daq-cmake daq-buildtools"
